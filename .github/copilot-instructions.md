# GitHub Copilot Instructions -- RG Sandbox

**Template Version**: 3.0.0
**Last Updated**: February 23, 2026
**Project**: RG Sandbox -- Active Azure sandbox resource group managing 18 deployed resources at ~/month with FinOps patterns for EsDAICoE.
**Path**: `C:\AICOE\eva-foundry\22-rg-sandbox\`
...
4. **Query the data model** for this project's record:
   `powershell
   Invoke-RestMethod "http://localhost:8010/model/projects/22-rg-sandbox" | Select-Object id, maturity, notes
   `
...
This file is the copilot-instructions for **22-rg-sandbox** (RG Sandbox).
...
Once this file has been loaded, the active project is locked to **22-rg-sandbox** for the entire session.
...
**Name**: RG Sandbox
**Folder**: `C:\AICOE\eva-foundry\22-rg-sandbox`
**ADO Epic**: [TODO]
**37-data-model record**: `GET /model/projects/22-rg-sandbox`
**Maturity**: active
**Phase**: Phase 2 -- 18 Resources Active

**Depends on**:
- 14-az-finops -- [TODO: why]
...
Invoke-RestMethod "http://localhost:8010/model/endpoints/" |
  Where-Object { $_.implemented_in -like '*22-rg-sandbox*' } |
