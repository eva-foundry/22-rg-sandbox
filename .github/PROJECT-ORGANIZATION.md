...
<!-- Placeholders: 22-rg-sandbox = project folder name | 2026-03-15 = YYYY-MM-DD format | agent:copilot = agent:name or human:name -->

# 22-rg-sandbox - Organization Standards
