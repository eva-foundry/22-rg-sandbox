# 22-rg-sandbox -- Acceptance Criteria
...
**Criteria**: `GET /model/projects/22-rg-sandbox` returns maturity, phase, pbi_total >= 1.
**Verification**:
```powershell
Invoke-RestMethod "http://localhost:8010/model/projects/22-rg-sandbox" |
...
**Verification**: Run MCP tool `audit_project` with target_path = C:\eva-foundry\22-rg-sandbox
**Status**: PENDING
...
**Verification**: Run MCP tool `get_trust_score` with repo_path = C:\eva-foundry\22-rg-sandbox
**Status**: PENDING
...
**Verification**: Run MCP tool `check_encoding` with target_path = C:\eva-foundry\22-rg-sandbox
**Status**: PENDING
